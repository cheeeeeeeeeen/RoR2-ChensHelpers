...
namespace Chen.Helpers.GeneralHelpers
{
    ...
    {
        private static void SetShaderKeywordBasedOnBool(bool enabled, Material material, string keyword)
        {
            if (!material)
            {
        ...
        private static void PutMaterialIntoMeshRenderer(Renderer meshRenderer, Material material)
        {
        ...
        /// <summary>
        /// Attach this component to a Game Object and assign the Renderer field.
        ...
        {
            /// <summary>
            /// Mandatory to be assigned after this component is added to a game object.
            /// </summary>
                    ...
                    if (Material)
                    {
                        ...
                        switch (Material.shader.name)
                        {
                            case "Hopoo Games/Deferred/Standard":
                                controller = gameObject.AddComponent<HGStandardController>();
                                break;

                            case "Hopoo Games/FX/Cloud Remap":
                                controller = gameObject.AddComponent<HGCloudRemapController>();
                                break;

                            case "Hopoo Games/FX/Cloud Intersection Remap":
                                controller = gameObject.AddComponent<HGIntersectionController>();
                                break;
                        }
                        if (controller)
                        {
