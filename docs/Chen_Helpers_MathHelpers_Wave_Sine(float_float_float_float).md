...
<a name='Chen_Helpers_MathHelpers_Wave_Sine(float_float_float_float)_frequency'></a>
...
<a name='Chen_Helpers_MathHelpers_Wave_Sine(float_float_float_float)_amplitude'></a>
`amplitude` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')  
Maximum and minimum values
  
<a name='Chen_Helpers_MathHelpers_Wave_Sine(float_float_float_float)_baseValue'></a>
